...
namespace Ex03.ConsoleUI
{
    ...
    internal class ImplementationOfTheUserInterface
    {
...
{Convert.ToInt32(eMenuOptions.Exit)}. Exit.");
        ...
        public static void AddNewVehicleToGarage()
        {
            ...
            try
            {
                ...
                if (m_GLM.IsLicenseNumberAlreadyInTheGarage(licenseNumber))
                {
                ...
                else
                {
                    ...
                    customerDetails = m_GLM.AddVehicleToTheGarage(licenseNumber, strVehicleTypeFromUser);
